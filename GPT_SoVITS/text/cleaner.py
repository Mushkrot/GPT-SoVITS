...
def clean_text(text, language, version=None):
    ...
    if version == "v1":
        ...
        language_module_map = {"zh": "chinese2", "ja": "japanese", "en": "english", "ko": "korean", "yue": "cantonese", "ru": "english"}
    ...
    elif language == "en" or language == "ru":  # Используем английский фонетизатор для русского текста
